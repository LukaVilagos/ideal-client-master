...
import EmployeeButton from "../../layout/buttons/EmployeeButton";
import PrintButton from "../../layout/buttons/PrintButton";
import SelectButton from "../../layout/buttons/SelectButton";
...
const ReportTableAll = () => {
  ...
  if (reportsStatus === "success") {
    return (
      <div className="bg-white border-2 rounded-lg w-full min-w-[72rem] max-w-6xl max-h-[70vh] overflow-y-scroll">
        {employee && (
          <PopupComponent>
            <div>
        ...
        <div className="flex justify-between py-2 px-4 items-center sticky top-0 bg-white border-b ">
          <div>
            <h3 className="text-xl uppercase tracking-widest">All Reports</h3>
          </div>
            ...
            {reports
              ? reports.map((report, index) => (
                  <tr key={index} className="border-b">
                    ...
                    <td className="flex max-w-4xl overflow-x-scroll border-l px-2  justify-between items-center p-4">
                      <ReportElements elements={report.RE} tableMode={true} />
                    </td>
